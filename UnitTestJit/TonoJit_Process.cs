...
namespace UnitTestProject1
{
    ...
    public class TonoJit_Process
    {
        ...
        public void Test012_CiSwitchNextLink()
        {
            ...
            st.Model.Procs.Add(B = new JitProcess // 分岐元
            {
                Name = "B",
            });
            ...
            st.Model.Procs.Add(A = new JitProcess  // 前工程
            {
                Name = "A",
            });
        ...
        public void Test011_get_y1_and_z1_from_w1_assy_with_CoJoinFrom()
        {
            ...
            st.Model.Procs.Add(B = new JitProcess  // 次工程（合流工程）
            {
                Name = "B",
            });
            st.Model.Procs.Add(C = new JitProcess  // 分岐工程
            {
                Name = "C",
            });
            st.Model.Procs.Add(Y = new JitProcess  // 横工程Y
            {
                Name = "Y",
            });
            st.Model.Procs.Add(Z = new JitProcess  // 横工程Z
            {
                Name = "Z",
            });
            st.Model.Procs.Add(SINK = new JitProcess // 消滅工程
            {
                Name = "SINK",
            });
            st.Model.Procs.Add(D = new JitProcess // 分岐工程
            {
                Name = "D",
            });
        ...
        public void Test010_CoJoinFrom()
        {
            ...
            st.Model.Procs.Add(B = new JitProcess  // 次工程
            {
                Name = "B",
            });
            st.Model.Procs.Add(Y = new JitProcess  // 横工程Y
