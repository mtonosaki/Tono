...
namespace UnitTestJit
{
    ...
    public class JitProcessTest
    {
        ...
        public void Test012_CiSwitchNextLink()
        {
            ...
            st.Subset.AddChildProcess(SINK = new JitProcess
            {
                Name = "SINK",
            });
            st.Subset.AddChildProcess(X = new JitProcess
            {
                Name = "X",
            ...
            st.Subset.AddChildProcess(Y = new JitProcess
            {
                Name = "Y",
            });
            st.Subset.AddProcessLink(Y, SINK);

            st.Subset.AddChildProcess(B = new JitProcess // 分岐元
            {
                Name = "B",
            });
            ...
            st.Subset.AddChildProcess(A = new JitProcess  // 前工程
            {
                Name = "A",
            });
        ...
        public void Test011_get_y1_and_z1_from_w1_assy_with_CoJoinFrom()
        {
            ...
            st.Subset.AddChildProcess(B = new JitProcess  // 次工程（合流工程）
            {
                Name = "B",
            });
            st.Subset.AddChildProcess(C = new JitProcess  // 分岐工程
            {
                Name = "C",
            });
            st.Subset.AddChildProcess(Y = new JitProcess  // 横工程Y
            {
                Name = "Y",
            });
            st.Subset.AddChildProcess(Z = new JitProcess  // 横工程Z
            {
                Name = "Z",
            });
            st.Subset.AddChildProcess(SINK = new JitProcess // 消滅工程
            {
                Name = "SINK",
            });
            st.Subset.AddChildProcess(D = new JitProcess // 分岐工程
            {
                Name = "D",
            });
        ...
        public void Test010_CoJoinFrom()
        {
            ...
            st.Subset.AddChildProcess(B = new JitProcess  // 次工程
            {
                Name = "B",
            });
            st.Subset.AddChildProcess(Y = new JitProcess  // 横工程Y
            ...
            dat = st.Engine.Events.Peeks(99).ToList(); k = 0;
            Assert.IsTrue(CMP(dat[k++], "w1", EventTypes.In, "10:00", "B"));
            Assert.AreEqual(st.Engine.GetWorks(st.Subset, SINK).Count(), 0);

            st.Engine.DoNext();
            dat = st.Engine.Events.Peeks(99).ToList(); k = 0;
            Assert.AreEqual(dat.Count, 0);
            Assert.AreEqual(st.Engine.GetWorks(st.Subset, SINK).Count(), 1);
        }
        ...
        public void Test005_JointProcess_No3()
        {
            ...
            st.Subset.AddChildProcess(JP = new JitProcessPriorityJoint
            {
                Name = "JP",
            });
            ...
            st.Subset.AddChildProcess(X);
            JP.AddChildProcess(X.ID);

            st.Subset.AddChildProcess(Y);
            JP.AddChildProcess(Y.ID);

            st.Subset.AddChildProcess(JP);
            st.Subset.AddChildProcess(Z = new JitProcess
            {
                Name = "Z",
            });
            st.Subset.AddChildProcess(SINK = new JitProcess
        ...
        public void Test001_tmStage_Basic()
        {
            ...
            Assert.IsTrue(CMP(dat[2], "c", EventTypes.Out, "9:02"));
            Assert.IsTrue(st.Engine.GetWorks(st.Subset, st.Subset.FindChildProcess("X")).Count() == 1);
            ...
            Assert.IsTrue(st.Engine.GetWorks(st.Subset, st.Subset.FindChildProcess("X")).Count() == 0);
            Assert.IsTrue(st.Engine.GetWorks(st.Subset, st.Subset.FindChildProcess("Y")).Count() == 1);
            ...
            Assert.IsTrue(st.Engine.GetWorks(st.Subset, st.Subset.FindChildProcess("Y")).Count() == 0);
            Assert.IsTrue(st.Engine.GetWorks(st.Subset, st.Subset.FindChildProcess("Z")).Count() == 1);
            ...
            Assert.IsTrue(st.Engine.GetWorks(st.Subset, st.Subset.FindChildProcess("X")).Count() == 1);
            Assert.IsTrue(st.Engine.GetWorks(st.Subset, st.Subset.FindChildProcess("Y")).Count() == 0);
            Assert.IsTrue(st.Engine.GetWorks(st.Subset, st.Subset.FindChildProcess("Z")).Count() == 2);
            ...
            Assert.IsTrue(st.Engine.GetWorks(st.Subset, st.Subset.FindChildProcess("X")).Count() == 0);
            Assert.IsTrue(st.Engine.GetWorks(st.Subset, st.Subset.FindChildProcess("Y")).Count() == 0);
            Assert.IsTrue(st.Engine.GetWorks(st.Subset, st.Subset.FindChildProcess("Z")).Count() == 3);
        }
